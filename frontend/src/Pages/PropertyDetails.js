        ...
        <section>
            <div className="container mx-auto min-h-[800px] mb-14">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div className="text-3xl font-semibold text-secondary ">$ {house.price}</div>
                </div>
                <div className="flex flex-col items-start gap-8 lg:flex-row">
                    ...
                    <div className="flex-1  bg-white  w-full mb-8 border border-gray-300 rounded-lg px-6 py-8 ">
                        ...
                        <form className="flex flex-col gap-y-4">
                            ...
                            <textarea
                                className="border border-gray-300 focus:border-blue-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400"
                                placeholder="Message*"
                                defaultValue="Hello , I am interested in [Modern Apartment]"
                            ></textarea>

                            <div className="flex gap-x-2 ">
                                <button className="bg-primary hover:bg-secondary text-white rounded  p-2 text-sm w-full transition" >
                                    Send Message
                                </button>
                                <button className="border border-blue-700 text-primary hover:border-primary hover:text-primary rounded p-2 text-sm w-full transition">
                                    Call
                                </button>
                            </div>
                        </form>
